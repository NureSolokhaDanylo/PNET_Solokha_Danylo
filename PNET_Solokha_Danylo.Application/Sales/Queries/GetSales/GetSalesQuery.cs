...
) : IRequestHandler<GetSalesQuery, SalesQueryResult>
{
    ...
    {
        logger.LogDebug("Handling GetSalesQuery: SearchTerm={SearchTerm}, MedicineId={MedicineId}, StartDate={StartDate}, EndDate={EndDate}, Skip={Skip}, Take={Take}",
        ...
        logger.LogDebug("Successfully fetched {Count} (out of {Total}) Sales.", items.Count, totalCount);
